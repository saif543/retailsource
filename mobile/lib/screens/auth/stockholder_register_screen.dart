...
class _StRS extends State<StockholderRegisterScreen>
  ...
  Future<void> _register() async {
    if (_nameCtrl.text.isEmpty || _phoneCtrl.text.isEmpty ||
      ...
      _err(S('fill_all_fields_category')); return;
    }
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(S('stockholder_signup'), style: const TextStyle(color: Colors.white,
                          fontSize: 20, fontWeight: FontWeight.w900, letterSpacing: -.4)),
                      const SizedBox(height: 2),
                      Text(S('join_as_supplier'),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                _card(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  _label(S('what_do_you_supply')),
                  Padding(
                    padding: const EdgeInsets.only(left: 2, bottom: 12),
                    child: Text(S('select_all_apply'),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  _Tap(onTap: () => Navigator.pushReplacement(context,
                    ...
                    child: Text(S('sign_in'), style: const TextStyle(color: _sg2,
